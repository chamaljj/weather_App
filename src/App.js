...
//API key
const APIkey = "d6d89d229f917a8add52f89184027a94";
...
const App = () => {
  ...
  return (
    ...
    flex flex-col items-center justify-center py-2 lg:px-2"
    >
      {errorMsg && (
        <div
          className="w-full max-w-[65vw] lg:max-w-[450px] bg-[#ff208c] text-center
       text-white absolute top-2 lg:top-2 p-3 capitalize rounded-md"
        >
      ...
      <form
       ...
       h-16 bg-black/30 w-full max-w-[450px] rounded-full backdrop-blur-[32px] mb-4 `}
      >
      ...
      {/* card */}
      <div className="w-full h-screen max-w-[450px] bg-black/20 max-h-[440px] text-white  backdrop-blur-[32px] rounded-[32px] py-2 px-6">
        {loading ? (
